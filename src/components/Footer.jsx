    ...
    <footer className="border-t border-hairline bg-ink-soft">
      <div className="section-shell grid grid-cols-2 gap-10 py-16 md:grid-cols-4 lg:grid-cols-5">
        <div className="col-span-2 flex flex-col gap-4 lg:col-span-2">
          <a href="#/" className="flex items-center gap-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold">
          ...
          <p className="text-pretty max-w-xs font-display text-lg leading-snug text-cream/70">
            Healthcare & Tourism.
            <span className="block text-sunset-gold">Comfort, Confidence, and Care.</span>
          </p>
        </div>
        ...
        <nav aria-label="Destinations" className="flex flex-col gap-3">
          ...
          {DESTINATIONS.map((d) => (
            <a key={d.name} href="#/destination" className="text-sm text-cream/70 transition-colors duration-300 hover:text-sunset-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold">
              {d.name}
            </a>
          ))}
        </nav>
        ...
        <nav aria-label="Services" className="flex flex-col gap-3">
          ...
          {SERVICES.map((s) => (
            <a key={s} href="#/" className="text-sm text-cream/70 transition-colors duration-300 hover:text-sunset-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold">
              {s}
            </a>
          ))}
        </nav>
