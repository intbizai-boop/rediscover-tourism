...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="section-shell relative flex min-h-[100svh] items-start pb-16 pt-28 md:items-center md:pb-0 md:pt-0">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.p
            variants={item}
            className="text-pretty max-w-md text-base leading-relaxed text-cream/80 md:text-lg"
          >
